...
Upon forging your project, several directories and files are automatically generated for you. This initial structure is designed to streamline the setup process and provide a solid foundation for further development.
...
[https://hxca5fw6h4.execute-api.us-east-2.amazonaws.com/staging/hello_world](https://hxca5fw6h4.execute-api.us-east-2.amazonaws.com/staging/hello_world).
...
With the Lambda function's URL at hand, we identify that the segment before `/hello_world` acts as the BASE URL. For the purposes of this tutorial, the BASE URL is `https://hxca5fw6h4.execute-api.us-east-2.amazonaws.com/staging`. This is the URL you need to copy.
...
"bucket": "",
"coverage": 80,
"base_url": "https://hxca5fw6h4.execute-api.us-east-2.amazonaws.com/staging"
...
```
...
- Dev: [https://rlb7cyuqfh.execute-api.us-east-2.amazonaws.com/dev/hello_world](https://rlb7cyuqfh.execute-api.us-east-2.amazonaws.com/dev/hello_world)
- Staging: [https://hxca5fw6h4.execute-api.us-east-2.amazonaws.com/staging/hello_world](https://hxca5fw6h4.execute-api.us-east-2.amazonaws.com/staging/hello_world)
- Prod: [https://5sk3lmuuh2.execute-api.us-east-2.amazonaws.com/prod/hello_world](https://5sk3lmuuh2.execute-api.us-east-2.amazonaws.com/prod/hello_world)
